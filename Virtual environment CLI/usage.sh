...
"$venv" update cached_wallpapers "Adelph" --env "$temp_install_dir" --vt array
eval "cached_wallpapers=( $("$venv" get cached_wallpapers --env "$temp_install_dir") )"
echo "Updated cached wallpapers are: ${cached_wallpapers[@]}"

"$venv" update cached_wallpapers "some" --env "$temp_install_dir"
eval "cached_wallpapers=( $("$venv" get cached_wallpapers --env "$temp_install_dir") )"
echo "Updated cached wallpapers are: ${cached_wallpapers[@]}"
...
#"$venv" update cached_wallpapers "Orion" "Caprus" "Iytu" --env "$temp_install_dir"
#eval "cached_wallpapers=( $("$venv" get cached_wallpapers --env "$temp_install_dir") )"
#echo "Updated cached wallpapers are: ${cached_wallpapers[@]}"
#echo "First cached wallpaper is: ${cached_wallpapers[0]}"
